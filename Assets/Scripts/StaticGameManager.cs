...
public static class StaticGameManager
{
    ...
    // Updates the counter of how many times player has visited each room
    // Used to trigger the correct conditional dialogue (ex. on first visit, on second visit, on subsequent visits)
